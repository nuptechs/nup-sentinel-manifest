import { LayoutDashboard, FolderUp, FileSearch, Map, Network, GitCompare, GitBranch, ShieldAlert, Settings, Ruler, Target, Workflow, Microscope } from "lucide-react";
...
const navItems = [
  ...
  { title: "Evidência", url: "/evidence", icon: Microscope },
