...
export function generatePolicyMatrix(manifest: ManifestData): PolicyMatrixOutput {
...
function buildUniversalMatrix(manifest: ManifestData): PolicyEntry[] {
...
function buildKeycloakPolicy(manifest: ManifestData, matrix: PolicyEntry[]): KeycloakPolicy {
...
function buildOktaPolicy(manifest: ManifestData, matrix: PolicyEntry[]): OktaPolicy {
  ...
  return {
    ...
    description: `Auto-generated by Manifest — ${matrix.length} resource policies`,
    rules,
    groups,
  };
}

function buildAWSIAMPolicies(manifest: ManifestData, matrix: PolicyEntry[]): Record<string, AWSIAMPolicy> {
