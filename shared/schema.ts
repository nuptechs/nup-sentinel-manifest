...
export const projects = pgTable("projects", {
  ...
  // PROVISIONAMENTO: desde 2026-07-23 o preDeployCommand (railway.toml) roda
  // `npx drizzle-kit push` antes de trocar o tráfego — coluna/tabela ADITIVA
  // aplica sozinha; mudança destrutiva falha o deploy (sem TTY) = fail-closed.
